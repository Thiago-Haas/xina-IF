...
HD_PWD='/home/haas/Documents/Github/XINA-IF/vivado/XINA-IF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tcc_top_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tcc_top_master.tcl
