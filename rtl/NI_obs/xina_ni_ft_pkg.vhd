...
package xina_ni_ft_pkg is
  ...
  constant c_ENABLE_TG_HAMMING_INJECT_ERROR  : boolean := true;
  ...
  constant c_ENABLE_TM_HAMMING_INJECT_ERROR  : boolean := true;
  ...
  constant c_ENABLE_LB_HAMMING_INJECT_ERROR  : boolean := true;
