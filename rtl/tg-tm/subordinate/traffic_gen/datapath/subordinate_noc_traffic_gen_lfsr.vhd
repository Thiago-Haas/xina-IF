...
-- Combinational LFSR core for subordinate NoC TG.
-- Matches the manager traffic_gen_datapath_lfsr polynomial.
entity subordinate_noc_traffic_gen_lfsr is
  generic(
    p_WIDTH : positive := 32
  );
  port(
...
architecture rtl of subordinate_noc_traffic_gen_lfsr is
  signal fb : std_logic;
begin
