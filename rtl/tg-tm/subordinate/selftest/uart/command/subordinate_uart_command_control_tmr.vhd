...
-- TMR wrapper for subordinate_uart_command_control.
entity subordinate_uart_command_control_tmr is
  port (
    ACLK    : in  std_logic;
...
architecture rtl of subordinate_uart_command_control_tmr is
