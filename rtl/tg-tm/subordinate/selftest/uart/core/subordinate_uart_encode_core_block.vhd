...
begin
  ...
  u_datapath: entity work.subordinate_uart_encode_datapath
    generic map(
      p_USE_UART_RX_COUNT_HAMMING => p_USE_UART_RX_COUNT_HAMMING,
      p_USE_UART_CORRECT_COUNT_HAMMING => p_USE_UART_CORRECT_COUNT_HAMMING,
      ...
      p_USE_UART_RX_COUNT_HAMMING_INJECT_ERROR => p_USE_UART_RX_COUNT_HAMMING_INJECT_ERROR,
      p_USE_UART_CORRECT_COUNT_HAMMING_INJECT_ERROR => p_USE_UART_CORRECT_COUNT_HAMMING_INJECT_ERROR,
    ...
    port map(
      ...
      received_count_i => TM_RECEIVED_COUNT_i,
      correct_count_i => TM_CORRECT_COUNT_i,
      flags_i => flags_i,
      OBS_SUB_UART_HAM_RX_COUNT_CORRECT_ERROR_i => OBS_SUB_UART_HAM_RX_COUNT_CORRECT_ERROR_i,
      OBS_SUB_UART_HAM_CORRECT_COUNT_CORRECT_ERROR_i => OBS_SUB_UART_HAM_CORRECT_COUNT_CORRECT_ERROR_i,
