...
-- Critical timing/state block for subordinate UART periodic reporting.
entity subordinate_uart_encode_critical is
  generic(
...
architecture rtl of subordinate_uart_encode_critical is
