...
architecture rtl of manager_tg_tm_lb_selftest_top is
  ...
  signal OBS_BE_RX_TMR_DEPKTZ_CTRL_CORRECT_ERROR_w : std_logic;
...
begin
  ...
  u_manager_uart_obs_block: entity work.manager_uart_obs_block
    port map (
      ...
      OBS_BE_RX_TMR_DEPKTZ_CTRL_CORRECT_ERROR_o => OBS_BE_RX_TMR_DEPKTZ_CTRL_CORRECT_ERROR_w,
      ...
      OBS_BE_RX_TMR_DEPKTZ_CTRL_ERROR_i => OBS_BE_RX_TMR_DEPKTZ_CTRL_ERROR_w,
  ...
  u_manager_tg_tm_lb_system_top: entity work.manager_tg_tm_lb_system_top
    port map (
      ...
      OBS_BE_RX_TMR_DEPKTZ_CTRL_CORRECT_ERROR_i => OBS_BE_RX_TMR_DEPKTZ_CTRL_CORRECT_ERROR_w,
