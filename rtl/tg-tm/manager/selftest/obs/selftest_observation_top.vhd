...
entity selftest_observation_top is
  generic (
...
architecture rtl of selftest_observation_top is
...
begin
  ...
  begin
    gen_obs_start_done_ctrl_plain : if not p_USE_OBS_START_DONE_CTRL_TMR generate
      u_tg_tm_start_done_controller: entity work.selftest_obs_start_done_control
        port map(
          ACLK    => ACLK,
          ARESETn => ARESETn,
    ...
    gen_obs_start_done_ctrl_tmr : if p_USE_OBS_START_DONE_CTRL_TMR generate
      u_tg_tm_start_done_controller_tmr: entity work.selftest_obs_start_done_control_tmr
        port map(
          ACLK    => ACLK,
          ARESETn => ARESETn,
          experiment_run_enable_i  => experiment_run_enable_w,
    ...
    u_tg_tm_seed_and_addr_constants: entity work.selftest_obs_seed_addr_datapath
      port map(
        tg_addr_o => tg_addr_o,
        tg_seed_o => tg_seed_o,
        tm_addr_o => tm_addr_o,
