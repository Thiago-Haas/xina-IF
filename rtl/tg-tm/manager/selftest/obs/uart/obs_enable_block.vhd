...
entity selftest_obs_enable_block is
  port (
    ACLK    : in  std_logic;
...
architecture rtl of selftest_obs_enable_block is
  signal obs_enable_w : std_logic;
begin
  b_obs_enable_ctrl: block
  begin
    u_obs_enable_ctrl: entity work.selftest_obs_enable_control
      port map(
        ACLK    => ACLK,
        ARESETn => ARESETn,
  ...
  begin
    u_obs_enable_dp: entity work.selftest_obs_enable_datapath
      port map(
