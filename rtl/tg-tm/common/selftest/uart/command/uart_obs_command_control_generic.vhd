...
-- Generic UART command control for OBS/self-test blocks.
-- S/P control run, R emits a one-cycle reset pulse, E/D enable/disable
-- correction enables exported toward protected blocks.
entity uart_obs_command_control_generic is
  port(
    ACLK    : in  std_logic;
...
architecture rtl of uart_obs_command_control_generic is
